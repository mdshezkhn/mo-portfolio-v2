...
graph TD
    ...
    D1(snippets/cv_snippets.md) --> D
    D2(snippets/linkedin_snippets.md) --> D
    D3(snippets/interview_snippets.md) --> D
```
...
graph LR
    ...
    F6[Finding 6: Mixed Wait-Time Effects] --> EX[Excluded - Internal Only]
```
